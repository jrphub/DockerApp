...
docker exec -it $(docker-compose ps -q cassandra) cqlsh -e "CREATE TABLE gis.tweets (id text, text text, createdAt text, source text, lang text, sentiment text, fullText text, location text, country text PRIMARY KEY);"
